...
const supportedDevices: ISupported[] = [
  ...
  },
  {
    title: "Google Play",
    shouldHideOnMobile: false,
    icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="icon"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.196 20.822l8.743-8.727-8.743-8.743c-.215.347-.364.91-.364 1.722V19.1c0 .811.149 1.374.364 1.722zM15.63 15.787l-2.864-2.88-8.51 8.527h.083c.728 0 1.357-.265 2.367-.811l8.925-4.836zM16.704 8.965l-3.113 3.13 3.113 3.113 1.888-1.027c.695-.38 1.755-1.076 1.755-2.086 0-1.027-1.06-1.723-1.755-2.104l-1.888-1.026zM4.256 2.738l8.51 8.528 2.865-2.88L6.706 3.55c-1.01-.547-1.639-.812-2.367-.812h-.083z" fill="currentColor"></path></svg>
  },
  {
    title: "MacOS",
        ...
        <div className="grid">
          ...
          <div className="anytime__content">
            ...
            <div className="any flex">
              {
                supportedDevices.map(item => <div className={`${item.shouldHideOnMobile ? 'hideOnMob': ''}`}>
                  {item.icon}
                  <p>{item.title}</p>
                </div>)
              }
