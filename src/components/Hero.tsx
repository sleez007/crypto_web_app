        ...
        <div className="container grid">
            <div className="hero__detail">
                ...
                <p className="flex gap-1">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="icon"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.288 12l-3.89 3.89 1.768 1.767L15.823 12l-1.768-1.768-3.889-3.889-1.768 1.768 3.89 3.89z" fill="currentColor"></path></svg>
                </p>
                <div className="cta-wrap">
                    <button className='btn btn--primary btn--medium btn--full-width'>
                        <span>Sign Up with Email or Phone</span>
                    </button>
                    <p className="cta-option flex gap-1"><div className='line' /> or continue with <div className='line' /></p>
                </div>
            </div>
